...
namespace LostAndFound.Web
{
    ...
    public class ApplicationUserManager : UserManager<AppUser,Guid>
    {
        ...
        {
            var manager = new ApplicationUserManager(new LAFUserStore(context.Get<AppDbContext>()));
    ...
    public class LAFUserStore : UserStore<AppUser, AppRole, Guid, AppUserLogin, AppUserRole, AppUserClaim>
    {
        public LAFUserStore(AppDbContext context)
            : base(context)
        {
        }
    }

    public class LAFRoleStore : RoleStore<AppRole, Guid, AppUserRole>
    {
        public LAFRoleStore(AppDbContext context) : base(context) { }
    }

    public class LAFRole : IdentityRole<Guid, AppUserRole>
    {
        public LAFRole() { }
        public LAFRole(string name) { Name = name; }
    }
}
